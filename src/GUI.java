...
public class GUI
{
    ...
    private JLabel GChart;
    
    public GUI()
    {
        model = new DefaultTableModel(new String[]{"Process", "ArrivalTime", "BurstTime", "Priority", "WaitingTime", "TurnAroundTime"}, 0);
        ...
        GChart = new JLabel("Gantt Chart");
        GChart.setBounds(30, 280,85,25);
        ...
        clearBtn.setBounds(210 , 280, 85, 25);
